...
const group = getFeatureStoryGroup('경영주 세무사연결', '웹');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/경영주 세무사연결/웹',
  component: ScreenStory,
  args: { screenId: 'owner-taxation-web', theme: 'calm' },
...
export const OwnerTaxationWeb = story('owner-taxation-web');
