...
const group = getFeatureStoryGroup('직원 계약서', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/직원 계약서/앱',
  component: ScreenStory,
  args: { screenId: 'employee-contract-mobile', theme: 'calm' },
...
export const EmployeeContractMobile = story('employee-contract-mobile');
export const EmployeeContractDetailMobile = story('employee-contract-detail-mobile');
