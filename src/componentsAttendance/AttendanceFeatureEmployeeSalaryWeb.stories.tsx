...
const group = getFeatureStoryGroup('직원 급여', '웹');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/직원 급여/웹',
  component: ScreenStory,
  args: { screenId: 'employee-salary-web', theme: 'calm' },
...
export const EmployeeSalaryWeb = story('employee-salary-web');
