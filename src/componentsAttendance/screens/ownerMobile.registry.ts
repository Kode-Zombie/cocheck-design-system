import {
  ...
  OwnerHomeMobile,
  OwnerMeMobile,
  OwnerMemoCreateMobile,
  OwnerMemoDetailMobile,
  OwnerMemoMobile,
  OwnerPayrollMobile,
...
export const ownerMobileScreens: AttendanceScreen[] = [
  ...
  { id: 'owner-memo-detail-mobile', label: 'OM2b · 메모 상세·댓글 (경영주)', group: '경영주 모바일', width: 390, height: 844, viewport: 'mobile', Component: OwnerMemoDetailMobile },
  { id: 'owner-memo-create-mobile', label: 'F3 · 메모 작성 (경영주 모바일)', group: '경영주 모바일', width: 402, height: 874, viewport: 'mobile', Component: OwnerMemoCreateMobile },
  ...
  { id: 'owner-stores-mobile', label: '04 · 내 매장', group: '경영주 모바일', width: 402, height: 874, viewport: 'mobile', Component: OwnerStoresMobile },
