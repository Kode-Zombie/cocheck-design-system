...
const group = getFeatureStoryGroup('직원 할 일', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/직원 할 일/앱',
  component: ScreenStory,
  args: { screenId: 'employee-todo-mobile', theme: 'calm' },
...
export const EmployeeTodoMobile = story('employee-todo-mobile');
export const EmployeeTodoCreateMobile = story('employee-todo-create-mobile');
