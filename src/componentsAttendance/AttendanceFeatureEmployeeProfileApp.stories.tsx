...
const group = getFeatureStoryGroup('직원 프로필', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/직원 프로필/앱',
  component: ScreenStory,
  args: { screenId: 'employee-profile-mobile', theme: 'calm' },
...
export const EmployeeProfileMobile = story('employee-profile-mobile');
