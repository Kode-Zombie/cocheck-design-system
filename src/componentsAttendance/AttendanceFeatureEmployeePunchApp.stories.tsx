...
const group = getFeatureStoryGroup('직원 출퇴근', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/직원 출퇴근/앱',
  component: ScreenStory,
  args: { screenId: 'employee-punch-mobile', theme: 'calm' },
...
export const EmployeePunchMobile = story('employee-punch-mobile');
