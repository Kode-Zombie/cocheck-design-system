...
const group = getFeatureStoryGroup('사장님 프로필', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/사장님 프로필/앱',
  component: ScreenStory,
  args: { screenId: 'owner-me-mobile', theme: 'calm' },
...
export const OwnerMeMobile = story('owner-me-mobile');
export const OwnerProfileEditMobile = story('latest-owner-profile-edit-mobile');
