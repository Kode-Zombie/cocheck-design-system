...
const group = getFeatureStoryGroup('직원 근태보고', '웹');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/직원 근태보고/웹',
  component: ScreenStory,
  args: { screenId: 'latest-employee-late-report-web', theme: 'calm' },
...
export const EmployeeLateReportWeb = story('latest-employee-late-report-web');
