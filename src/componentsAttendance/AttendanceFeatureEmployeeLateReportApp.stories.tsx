...
const group = getFeatureStoryGroup('직원 근태보고', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/직원 근태보고/앱',
  component: ScreenStory,
  args: { screenId: 'employee-late-mobile', theme: 'calm' },
...
export const EmployeeLateMobile = story('employee-late-mobile');
