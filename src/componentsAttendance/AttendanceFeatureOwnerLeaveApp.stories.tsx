...
const group = getFeatureStoryGroup('사장님 휴가관리', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/사장님 휴가관리/앱',
  component: ScreenStory,
  args: { screenId: 'latest-owner-leave-mobile', theme: 'calm' },
...
export const OwnerLeaveMobile = story('latest-owner-leave-mobile');
