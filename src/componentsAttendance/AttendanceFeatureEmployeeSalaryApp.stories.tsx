...
const group = getFeatureStoryGroup('직원 급여', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/직원 급여/앱',
  component: ScreenStory,
  args: { screenId: 'employee-salary-mobile', theme: 'calm' },
...
export const EmployeeSalaryMobile = story('employee-salary-mobile');
