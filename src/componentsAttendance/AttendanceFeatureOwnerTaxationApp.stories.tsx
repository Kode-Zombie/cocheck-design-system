...
const group = getFeatureStoryGroup('경영주 세무사연결', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/경영주 세무사연결/앱',
  component: ScreenStory,
  args: { screenId: 'latest-owner-taxation-mobile', theme: 'calm' },
...
export const OwnerTaxationMobile = story('latest-owner-taxation-mobile');
