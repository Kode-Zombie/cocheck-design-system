...
const group = getFeatureStoryGroup('경영주 초대관리', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/경영주 초대관리/앱',
  component: ScreenStory,
  args: { screenId: 'latest-owner-invite-list-mobile', theme: 'calm' },
...
export const OwnerInviteListMobile = story('latest-owner-invite-list-mobile');
