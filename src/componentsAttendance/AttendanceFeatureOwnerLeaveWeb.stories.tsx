...
const group = getFeatureStoryGroup('사장님 휴가관리', '웹');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/사장님 휴가관리/웹',
  component: ScreenStory,
  args: { screenId: 'owner-leave-web', theme: 'calm' },
...
export const OwnerLeaveWeb = story('owner-leave-web');
