...
const group = getFeatureStoryGroup('사장님 급여관리', '웹');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/사장님 급여관리/웹',
  component: ScreenStory,
  args: { screenId: 'owner-payroll-web', theme: 'calm' },
...
export const OwnerPayrollWeb = story('owner-payroll-web');
