...
const group = getFeatureStoryGroup('경영주 계약서', '앱');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/경영주 계약서/앱',
  component: ScreenStory,
  args: { screenId: 'latest-owner-labor-mobile', theme: 'calm' },
...
export const OwnerLaborMobile = story('latest-owner-labor-mobile');
