...
const group = getFeatureStoryGroup('직원 할 일', '웹');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/직원 할 일/웹',
  component: ScreenStory,
  args: { screenId: 'employee-todo-web', theme: 'calm' },
...
export const EmployeeTodoWeb = story('employee-todo-web');
