...
const group = getFeatureStoryGroup('경영주 통계리포트', '웹');
const ScreenStory = createScreenStory(group.screens);

const meta = {
  title: 'Attendance/기능별/경영주 통계리포트/웹',
  component: ScreenStory,
  args: { screenId: 'owner-stats-web', theme: 'calm' },
...
export const OwnerStatsWeb = story('owner-stats-web');
